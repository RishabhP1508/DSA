...
This is binary search adapted to a broken-but-structured order. The same "which side is sorted?" reasoning also finds the minimum/pivot of a rotated array.`,
  ...
  codeExplanations: [
    ...
    { line: 8, executable: false, explanation: "Comment: one side of mid is always sorted." },
    { line: 9, executable: false, explanation: "Comment: the left-sorted case." },
    ...
    { line: 12, executable: true, explanation: "Yes: search the left half." },
    { line: 13, executable: false, explanation: "Otherwise..." },
    { line: 14, executable: true, explanation: "...it must be in the right half." },
    { line: 15, executable: false, explanation: "Else: the RIGHT half is sorted." },
    { line: 16, executable: false, explanation: "Comment/branch: right-sorted case." },
    { line: 17, executable: true, explanation: "Is the target within the sorted right range (nums[mid], nums[hi]]?" },
    { line: 18, executable: true, explanation: "Yes: search the right half." },
    { line: 19, executable: false, explanation: "Otherwise..." },
    { line: 20, executable: true, explanation: "...search the left half." },
    { line: 21, executable: true, explanation: "Not found: return -1." },
    { line: 22, executable: false, explanation: "Blank line." },
    { line: 23, executable: true, explanation: "Search 0 in the rotated array → index 4." },
    { line: 24, executable: true, explanation: "Search 3 (absent) → -1." },
  ],
