...
The complexity split is worth internalizing: **existence** of a prefix is O(P), but **listing k matching words** costs O(P + total characters in the subtree) — you must actually visit each matching word. That's why autocomplete feels instant to *check* but takes more work to *populate* the suggestion list. The recognition cue: any "starts with / autocomplete / common-prefix" query points at a trie.`,
  ...
  codeExplanations: [
    ...
    { line: 27, executable: true, explanation: "Now count words in the prefix's subtree." },
    { line: 28, executable: true, explanation: "DFS the subtree with an explicit stack." },
    { line: 29, executable: true, explanation: "Pop a node." },
    { line: 30, executable: true, explanation: "If it ends a word..." },
    { line: 31, executable: true, explanation: "...count it." },
    { line: 32, executable: true, explanation: "Push its children to continue the subtree walk." },
    { line: 33, executable: true, explanation: "Return the total count." },
    { line: 34, executable: false, explanation: "Blank line." },
    { line: 35, executable: true, explanation: "Create a trie." },
    { line: 36, executable: true, explanation: "Insert cat, car, care, dog." },
    { line: 37, executable: true, explanation: "Insert each." },
    { line: 38, executable: true, explanation: "starts_with('ca') → True." },
    { line: 39, executable: true, explanation: "starts_with('do') → True." },
    { line: 40, executable: true, explanation: "starts_with('z') → False." },
    { line: 41, executable: true, explanation: "count_with_prefix('ca') → 3 (cat, car, care)." },
  ],
